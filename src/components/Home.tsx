...
interface HomeProps {
  onNavigate: (tab: 'ship' | 'radio' | 'alphabet' | 'flags') => void;
}
  ...
  return (
    <div className="w-full h-full bg-slate-950 flex flex-col items-center overflow-y-auto relative p-8">
      ...
      <div className="flex flex-col items-center mt-12 mb-20 relative z-10">
        ...
        <div className="mt-6 px-6 py-2 text-sm md:text-base font-bold bg-blue-900/40 text-blue-300 rounded border border-blue-700/50 uppercase tracking-widest shadow-inner">
